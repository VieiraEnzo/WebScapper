...
'''
A partir de um input doque pesquisar, o Scrapper busca todos os artigos relacionados, transformando-os em um json.
Além das bibliotecas é nescessário que voce instale o driver do Selenium para Firefox para que o programa funcione.
É possivel que o scrapper seja incapaz de pegar alguns artigos por algum problema no site.
'''
